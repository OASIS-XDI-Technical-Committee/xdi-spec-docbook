...
goto :start
  ...
  $Id: spectools-docbook-template.bat,v 1.2 2011/11/09 18:15:04 admin Exp $
...
call xslt spectools-docbook-template-%1.xml %oasis-ss-dir%oasis-specification-html.xsl spectools-docbook-template-%1-relative.html html.stylesheet=../css/oasis-spec.css oasis.logo=../OASISLogo.jpg
if %errorlevel% neq 0 goto :done
