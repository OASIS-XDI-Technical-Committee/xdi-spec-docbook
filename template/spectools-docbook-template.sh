...
sh ../../xslt.sh wd-spectools-docbook-template-$1.xml $oasis_ss_dir\oasis-specification-html.xsl spectools-docbook-template-$1-relative.html html.stylesheet=../css/oasis-spec.css oasis.logo=../OASISLogo.jpg
